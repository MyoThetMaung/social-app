  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-4 mt-4">
        <ul class="list-group">
          <li class="list-group-item hoverable"> <a href="{{ route('manage_premium_user') }}">Manage_Premium_User</a></li>
          <li class="list-group-item hoverable"> <a href="{{ route('contact_message') }}">Contact_message</a></li>
        </ul>
      </div>
      <div class="col-md-8">
        @yield('content')  
